...
- **代码部分 (The Code)**：基于 **[MIT License](https://opensource.org/licenses/MIT)** 开源，您可以自由地使用、修改和分发本项目的**源代码**。
- **内容部分 (The Content)**：所有教材**内容**的版权归原版权方所有，**不属于本许可证的授权范围**，使用者需自行确保遵守当地版权法规。
...
- **谢绝**：**任何请求或提交涉及教材实质内容的PR**，因其涉及版权问题，将无法合并。
